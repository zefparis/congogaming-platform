/**
 * Test Unipesa payment_c2b — VRAI débit. Envoie un push de paiement au customer.
 *   node scripts/unipesa-c2b-test.mjs <phone> <amount> <provider_id>
...
if (!phone || !amount || !provider_id) {
  console.error('Usage: node scripts/unipesa-c2b-test.mjs <phone> <amount> <provider_id>');
  process.exit(1);
}
...
const url = `https://api.unipesa.tech/${PUBLIC_ID}/payment_c2b`;
